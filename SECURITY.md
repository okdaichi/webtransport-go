...
If you discover a vulnerability that could affect production deployments (e.g., a remotely exploitable issue), please report it [**privately**](https://github.com/okdaichi/webtransport-go/security/advisories/new).
...
For bugs, feature requests, or other non-security concerns, please open a GitHub [issue](https://github.com/okdaichi/webtransport-go/issues/new).
